...
**Applied to JOBS:**
- fallback function and external payable functions in solidity: [Click here for SO's Answer](https://stackoverflow.com/questions/69178874/solidity-v0-6-0-fallback-functions-what-are-they-needed-for)- @cryptojobs:
- ===========
